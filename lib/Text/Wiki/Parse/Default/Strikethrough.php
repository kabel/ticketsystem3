...
/**
* 
* Parses for strike-through text.
* 
* @category Text
* 
* @package Text_Wiki
...
* strike-through as defined by text surrounded by two tildes.
* On parsing, the text itself is left in place, but the
* starting and ending instances of two tildes are replaced with
* tokens.
*
* @category Text
* 
