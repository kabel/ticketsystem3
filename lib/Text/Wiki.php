...
class Text_Wiki {
    ...
    */
     ...
     */
    static function factory($parser = 'Default', $rules = null)
    {
...
//Damn strtok()! Why does it "skip" empty parts of the string. It's useless now!
        ...
        if (count($this->_renderCallbacks)) {
            self::error('Render callbacks left over after processing finished');
        }
        /*
    ...
    function loadParseObj($rule)
    {
        ...
        if (! class_exists($class, false)) {
            ...
            if ($loc) {
                ...
                // can't find the class
                self::error("Parse rule '$rule' not found");
            }
        }
    ...
    function loadRenderObj($format, $rule)
    {
        ...
        if (! class_exists($class, false)) {
            ...
            if ($loc) {
                ...
                // can't find the class
                self::error("Render rule '$rule' in format '$format' not found");
            }
        }
    ...
    function loadFormatObj($format)
    {
        ...
        if (! class_exists($class, false)) {
            ...
            if ($loc) {
                ...
                // can't find the class
                self::error("Rendering format class '$class' not found");
            }
        }
